    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-10 flex justify-end pb-8">
          <button
            type="submit"
            className={`bg-red-600 text-white font-semibold mx-auto sm:mx-0 text-lg px-8 py-2.5 rounded-xl hover:bg-red-700 transition duration-300 ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
            disabled={isLoading}
          >
