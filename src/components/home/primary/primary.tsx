...
const Primary: React.FC = () => {
  ...
  return (
    <div className="relative h-screen">
      ...
      <div className="absolute inset-0 px-6 md:px-12 flex flex-col md:flex-row items-center flex justify-end h-full">
        <div className="relative w-full md:w-6/12 flex flex-col items-end md:items-end md:pl-24 mr-10 -mt-20">
          <h1 className="text-3xl font-black uppercase tracking-wide md:text-right mb-8 w-full">
          ...
          <p className="text-lg text-gray-200 mb-5 justify md:text-justify w-full">
            SAGIP PILIPINAS connects volunteers and organizations to those in need, streamlining relief efforts
            for a faster, more effective response. Coordinating aid, tracking resources, and mobilizing support,
            all made easier, ensuring that help reaches disaster-affected communities when they need it most.
          </p>
