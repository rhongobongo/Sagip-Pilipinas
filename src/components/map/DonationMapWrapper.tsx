...
const DonationMapWrapper: React.FC<DonationMapWrapperProps> = ({
    ...
    return (
        <div className="flex flex-col sm:flex-row h-screen border-2 border-red-400">
                    ...
                    <div className="bg-red-50 p-4 mb-6 rounded-lg border border-red-200 text-black">
                        ...
                        <div className="mt-2">
                            ...
                            <p className="font-semibold">
                                Contact:{" "}
                                <span className="font-normal">
                                    {selectedPin.contactNum}
                                </span>
                            </p>
                            <p className="font-semibold">
                                Calamity Type:{" "}
                                <span className="font-normal">
                                    {selectedPin.calamityType}
                                </span>
                            </p>
                            <p className="font-semibold">
                                Level:{" "}
                                <span className="font-normal">
                                    {selectedPin.calamityLevel}
                                </span>
                            </p>
                            <p className="font-semibold">
                                Date:{" "}
                            ...
                            <p className="font-semibold">
                                Location:{" "}
                                <span className="font-normal">
                                    {selectedPin.coordinates?.latitude.toFixed(
                                        6
                                    )}
                                    ,{" "}
                                    {selectedPin.coordinates?.longitude.toFixed(
                                        6
                                    )}
                                </span>
                            </p>
            ...
            {/* Right panel - Map */}
            <div className="w-full h-1/2 border-2 border-red-400 sm:outline-none sm:w-2/3 sm:h-full">
                <DynamicMap
                    ref={mapRef}
                    pins={pins}
