...
const DonationPage = async () => {
    ...
    try {
        ...
        console.error(
            "Server Component: Error fetching organization data:",
            error
        );
    ...
    if (errorMessage) {
        return (
            <div>
                Error: {errorMessage} Please try logging in or contact support.
            </div>
        );
    }
            ...
            <div className="grid justify-center">
                <div>
                    <h2 className="text-xl pt-6">
                        Help disaster victims by making donations through
                        filling up the form below. Anywhere you are, lending a
                        helping hand is always possible.
                    </h2>
                </div>
